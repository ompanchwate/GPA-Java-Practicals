...
public class Main
extends JComponent implements Serializable
{
...
{
String old = this.lines[index]; this.lines[index] = line;
...
int height = g.getFontMetrics().getHeight(); paintString( g, this.title, height );
if ( this.lines != null )
{
int step = height;
for ( String line : this.lines ) paintString( g, line, height += step );
}
}
...
public static void main(String[] args) { Main main=new Main(); main.setTitle("Napul");
main.setLines(2,"Napul"); 
String ak=main.getTitle(); 
String[] as=main.getLines(); 
